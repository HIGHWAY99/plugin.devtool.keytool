#############################################################################
#############################################################################
import os,xbmc,xbmcgui,xbmcaddon,sys,logging,re,urllib,urllib2,random,time,datetime,shutil
#############################################################################
#############################################################################
...
def popBrowseImage(title='',s='files',d=''):
	diag=xbmcgui.Dialog()
	r=diag.browseSingle(2,title,s,'',True,False,d)
	if r: return r
	else: return ''
	#del diag
